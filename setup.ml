...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7502f05053151836a13ea3d41a1faa02) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("json-pointer", None)
                        ];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for JSON predicate";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "json-predicate"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "L/\245\139\249\235w\204\000\250\185\225\2252\248\151";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
